    ...
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="flex flex-wrap gap-2 mb-2">
          <span className="inline-flex items-center px-2 py-0.5 rounded bg-blue-100 text-blue-800 text-xs font-medium dark:bg-blue-900 dark:text-blue-200">
          Full Stack Developer
          </span>
          <span className="inline-flex items-center px-2 py-0.5 rounded bg-green-100 text-green-800 text-xs font-medium dark:bg-green-900 dark:text-green-200">
          Web3 Enthusiast
          </span>
          <span className="inline-flex items-center px-2 py-0.5 rounded bg-purple-100 text-purple-800 text-xs font-medium dark:bg-purple-900 dark:text-purple-200">
          Open Source
          </span>
          <span className="inline-flex items-center px-2 py-0.5 rounded bg-yellow-100 text-yellow-800 text-xs font-medium dark:bg-yellow-900 dark:text-yellow-200">
          Freelancer
          </span>
        </div>
        <p className="text-muted-foreground text-base leading-relaxed">
          ...
          <br />
          Building modern web apps, exploring blockchain, and mentoring
          devs.
        </p>
        </div>
        <div className="w-36 h-36 rounded-full overflow-hidden ml-auto border-4 border-gray-200 dark:border-gray-700 shadow-lg">
        <Image
          src="/bajaj.jpg"
          alt="Sahil Bajaj"
          width={144}
      ...
      <section className="mb-12">
        ...
        {[
          ...
          <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">{tweet.content}</p>
          <p className="text-gray-700 dark:text-gray-300 text-sm">{tweet.time}</p>
          </div>
        ))}
        </div>
      </section>
